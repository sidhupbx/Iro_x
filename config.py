...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "sɪᴅʜᴜx ᴍᴜsɪᴄ")

OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5984447333").split())
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/lll_ABOUT_ME_lll")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/PUNJABI_CHATTING_GRPUP")
